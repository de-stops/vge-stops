...
This is a simple script to download all [VGE](http://www.vge-emsland-sued.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"101056","Leschede Kita St. Marien",7.304697,52.394535,""
```
